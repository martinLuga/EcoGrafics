...
module ExampleShaders =
    ...
    let vertexShaderDesc = 
        ShaderDescription(ShaderType.Vertex,    "shaders",  "VS","VSMain","vs_5_1", rootSignatureDesc, ShaderUsage.Required)

    let vertexShaderSkyDesc = 
        ShaderDescription(ShaderType.Vertex,    "shaders",  "Box","VSMain","vs_5_1", rootSignatureDesc, ShaderUsage.Required)
    
    let pixelShaderSkyDesc = 
        ShaderDescription(ShaderType.Pixel,     "shaders",  "Box","PSMain","ps_5_1", rootSignatureDesc, ShaderUsage.Required)
    
    let vertexShaderTesselateDesc = 
        ShaderDescription(ShaderType.Vertex,    "shaders",  "VS","VSPassThruTessellate","vs_5_1", rootSignatureDesc, ShaderUsage.Required)

    let vertexShaderDefaultDesc = 
        ShaderDescription(ShaderType.Vertex,    "shaders",  "Default","VS","vs_5_1", rootSignatureDesc, ShaderUsage.Required)

    let pixelShaderDefaultDesc = 
        ShaderDescription(ShaderType.Pixel,     "shaders",  "Default","PS","ps_5_1", rootSignatureDesc, ShaderUsage.Required)
 
    let pixelShaderSimpleDesc = 
        ShaderDescription(ShaderType.Pixel,     "shaders",  "SimplePS","PSMain","ps_5_1", rootSignatureDesc, ShaderUsage.Required)

    let domainShaderQuadDesc = 
        ShaderDescription(ShaderType.Domain,    "shaders",  "TessellateQuad","DS_Quads","ds_5_1", rootSignatureDesc, ShaderUsage.Required)

    let hullShaderQuadDesc = 
        ShaderDescription(ShaderType.Hull,      "shaders",  "TessellateQuad","HS_QuadsInteger","hs_5_1", rootSignatureDesc, ShaderUsage.Required)

    let domainShaderTriDesc = 
        ShaderDescription(ShaderType.Domain,    "shaders",  "TessellateTri","DS_Triangles","ds_5_1", rootSignatureDesc, ShaderUsage.Required)

    let domainShaderTesselatePhongDesc = 
        ShaderDescription(ShaderType.Domain,    "shaders",  "TessellatePhong","DS_PhongTessellation","ds_5_1", rootSignatureDesc, ShaderUsage.Required)

    let hullShaderTriDesc = 
        ShaderDescription(ShaderType.Hull,      "shaders",  "TessellateTri","HS_TrianglesInteger","hs_5_1", rootSignatureDesc, ShaderUsage.Required)
 
    let pixelShaderPhongDesc = 
         ShaderDescription(ShaderType.Pixel,    "shaders",  "PhongPS","PSMain","ps_5_1", rootSignatureDesc, ShaderUsage.Required)
 
    let pixelShaderLambertDesc = 
        ShaderDescription(ShaderType.Pixel,     "shaders",  "DiffusePS","PSMain","ps_5_1", rootSignatureDesc, ShaderUsage.Required)

    let pixelShaderBlinnPhongDesc = 
        ShaderDescription(ShaderType.Pixel,     "shaders",  "BlinnPhongPS","PSMain","ps_5_1", rootSignatureDesc, ShaderUsage.Required)
