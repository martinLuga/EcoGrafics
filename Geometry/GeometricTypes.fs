...
module GeometricTypes = 
   ...
   // 6 Indexe (2 Dreiecke) im Gegenuhrzeigersinn erzeugen
    ...
    let square p1 p2 p3 p4 normal color idx isTransparent =
        ...
        let v2 = createVertex p2 normal color  (new Vector2(grade, 0.0f)) isTransparent
        let v3 = createVertex p3 normal color  (new Vector2(grade, grade)) isTransparent
        let v4 = createVertex p4 normal color  (new Vector2(0.0f, grade)) isTransparent
