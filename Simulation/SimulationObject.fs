...
module SimulationObject =
    ...
    //       enthält mehrere Actions  
    // ---------------------------------------------------------------------------------------------------- 
    type Simulateable(name, geometry, surface, color, position, direction, velocity, moveRandom, energy, capacity) = 
        inherit Moveable(name, geometry, surface, color, position, direction, velocity, moveRandom ) 
