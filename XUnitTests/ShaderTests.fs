...
module ShaderTests =
    ...
    type NestedDictTests() = 
        ...
        [<DefaultValue>] val mutable ndict:NestedDict<ShaderClass, BlendType, RasterType, string>
        ...
        member this.setUp() =
            ...
            this.ndict  <- new NestedDict<ShaderClass, BlendType, RasterType, string>()
        ...
        member this.NestedDictAddTest() = 
            ...
            this.ndict.Add(
                ...
                "OK")
            let result = 
                this.ndict.Item(ShaderClass.SimpleVSType, ShaderClass.SimpleVSType, ShaderClass.TriDSType, ShaderClass.TriHSType, BlendType.Transparent, RasterType.Solid)
    ...
    type PsoStoreTests() = 
        ...
        member this.GetSuccessfullTest() = 
            ...
            try
                ...
                Assert.Pass()
            with 
            | :? PipelineStateNotFoundError as ex ->                 
    ...
    type PsoProviderTests() = 
        ...
        member this.GetPipelineStateTest() = 
            let pso = this.provider.GetPipelineState()
            Assert.NotNull(pso)
